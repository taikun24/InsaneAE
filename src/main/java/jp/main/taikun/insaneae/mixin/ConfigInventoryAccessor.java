 ...
 * 容量がそのまま効く)。</p>
 *
 * <p>フラグは {@code ConfigInventory.Builder#allowOverstacking} でしか渡せず、
 * インベントリを作るのは {@code InterfaceLogic} のコンストラクタの中なので、
 * 外から差し込む余地が無い。{@code final} フィールドなので {@code @Mutable} を付けて開ける。</p>
 *
